...
class LocationProvider with ChangeNotifier {
  ...
  void deleteUserAddressByID( id, int index, Function callback) async {
  ...
  Future<ResponseModel> addAddress(AddressModel addressModel) async {
    ...
    if (apiResponse.response != null &&
      ...
      if (apiResponse.response.statusCode == 202) {
        errorMessage = "Zip Code Address Already Exist";

      } else {
                errorMessage = "No service on this Zip Code";
         }
  ...
  Future<ResponseModel> updateAddress(BuildContext context,
    ...
    _errorMessage = '';
    _addressStatusMessage = null;
    print("ammar bhai : " + addressId.toString());
