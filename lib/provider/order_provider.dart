...
class OrderProvider extends ChangeNotifier {
  ...
  Future<void> placeOrder(
    ...
    if (apiResponse.response != null &&
      ...
      print("Order Date is: ");
      print(placeOrderBody.tranId);
           print("what is order type"+placeOrderBody.orderType);
    } else {
      String errorMessage;
  ...
  void cancelOrder(String orderID, Function callback) async {
    ...
    if (apiResponse.response != null &&
      ...
      _showCancelled = true;
       ...
       String message = 'Order Cancelled Successfully';  //map["message"];
      callback(message, true, orderID);
    } else {
