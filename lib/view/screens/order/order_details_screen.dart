                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      showDialog(context: context, builder: (context) => OrderCancelDialog(
                       ...
                       showCustomSnackBar('Order Cancelled successfully', context); // if bellow code is not working use this alternative
...
*/
              order.trackModel.orderStatus == 'delivered' ? Padding(
                ...
                child: CustomButton(
                  ...
                  onTap: () {
                    if(order.orderDetails[0].rating==''){
                    ...
                    showCustomSnackBar('${order.orderDetails[0].rating} star Rating Already Given Thanks', context);
                  }
                  },
                ),
              ) : SizedBox(),
